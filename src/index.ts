...
import { getWeatherCondition, getTemperature } from "./tools/WeatherApi";
...
groqClient.addFunction("getTemperature", getTemperature);
groqClient.addFunction("getWeatherCondition", getWeatherCondition);
